                    ...
                    <table class="table mb-0" id="sortable">
                        ...
                        @foreach ($list as $index => $p)
                            <tr id="recordsArray_{{ $p->id }}">
                                ...
                                <td class="option-120">
                                    <div class="btn-group">
                                        <a href="{{route('admin.developro.investment.floor.property.index', [$investment, $p])}}" class="btn action-button mr-1" data-toggle="tooltip" data-placement="top" title="Pokaż piętro"><i class="fe-folder"></i></a>
                                        <a href="{{route('admin.developro.investment.floor.edit', [$investment, $p])}}" class="btn action-button mr-1" data-toggle="tooltip" data-placement="top" title="Edytuj piętro"><i class="fe-edit"></i></a>
