    ...
    <div class="container">
        ...
        <div class="row mt-5 pt-2">
            ...
            <div class="col-12">
                ...
                @endif
                <form method="post" action="{{route('contact.property', $property->id)}}" class="validateForm">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            ...
                            <input name="form_phone" id="form_phone" class="form-control" type="text" value="{{ old('phone') }}">
                        </div>
