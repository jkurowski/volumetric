                ...
                <div class="offset-apla">
                    ...
                    <ul class="mb-0 list-unstyled">
                        <li>
                            ...
                            <p>Wybudowaliśmy już setki mieszkań, a kolejne mamy w planach. Mimo tego, że nie jesteśmy dużą korporacją, zaufało nam naprawdę wiele osób – nawet ci najbardziej wymagający – co sprawiło, że udało nam się zbudować silną pozycję na rynku. Gwarantujemy sprawne i indywidualne podejście do Twoich potrzeb.</p>
                        </li>
                        <li>
