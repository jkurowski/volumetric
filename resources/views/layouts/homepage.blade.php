                ...
                <div class="offset-apla">
                    ...
                    <ul class="mb-0 list-unstyled">
                        <li>
                            ...
                            <p>Wybudowaliśmy już tysiące mieszkań, a kolejne mamy w planach. Mimo tego, że nie jesteśmy dużą korporacją, zaufało nam naprawdę wiele osób – nawet ci najbardziej wymagający – co sprawiło, że udało nam się zbudować silną pozycję na rynku. Gwarantujemy sprawne i indywidualne podejście do Twoich potrzeb.</p>
                        </li>
                        <li>
                            ...
                            <p>W działalności deweloperskiej dobrze nas znają. W końcu działamy na rynku w Polsce już od ponad 13 lat. Zadowolenie i uznanie klientów jest dla nas najważniejsze, dlatego oferujemy najwyższy standard świadczonych usług.</p>
                        </li>
                        <li>
                            ...
                            <p>Nikt nie lubi czekać. Doskonale o tym wiemy, dlatego dokładamy wszelkich starań, aby realizować wszystkie inwestycje terminowo. Pomaga nam w tym nasze doświadczenie i wiedza oraz umiejętności.</p>
                        </li>
                    </ul>
                </div>
            </div>
